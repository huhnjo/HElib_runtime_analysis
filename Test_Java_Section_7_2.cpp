...
long testContext( long m, long phi_m, long d, long mvec1, long mvec2, long gens1, long gens2, long ords1, long ords2, long c_m ){
...
//{  p, phi(m),    m, d,  m1,  m2,  m3,   g1,    g2,   g3, ord1,ord2,ord3,c_m}
  ...
  //{  2, 60016, 60787, 22, 89, 683,  0,  2050, 58741,    0, 88, 31,   0, 200}
   ...
   /* for(int i = 0; i < 17; i++){
     testContext(table[i][2], table[i][1], table[i][3], table[i][4], table[i][5], table[i][7], table[i][8], table[i][10], table[i][11], table[i][13] );
     }*/

   /* ofstream runtimeResults;
   runtimeResults.open ("smallPlaintextValues.txt");
   ...
   for(int j = 0; j < 17; j++){       
     ...
     for(int i = 0; i < 3; i++){
       int b = 2;
       long time = testMult(a, b, table[j][2], table[j][1], table[j][3], table[j][4], table[j][5], table[j][7], table[j][8], table[j][10], table[j][11], table[j][13] );
   ...
   /*
    ofstream runtimeResults;
   runtimeResults.open ("midPlaintextValues.txt");
   ...
   */
   ...
   int j = 0;
   ofstream runtimeResults;
   // runtimeResults.open ("polynomialResultsNo1.txt");
   ...
   a = 4;
   b = 4;
   runtimeResults.open ("polynomialResultsNo2.txt");
   ...
   a = 8;
   b = 8;
   runtimeResults.open ("polynomialResultsNo3.txt");
   ...
   */
   ...
   runtimeResults.open("polynomialResultsNo4.txt");
   a = 128;
   b = 128;
